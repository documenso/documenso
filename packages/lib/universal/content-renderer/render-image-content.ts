...
import type { TContentImageMeta } from '../../types/envelope-content-meta';
import { DEFAULT_CONTENT_FONT_SIZE } from '../../types/envelope-content-meta';
...
import {
  ...
  CONTENT_PLACEHOLDER_TEXT_COLOR,
  calculateContainFit,
 ...
 */
export const renderImageContentElement = (
  content: ContentToRender,
  meta: TContentImageMeta,
  options: RenderContentOptions,
): Konva.Group => {
  const { pageWidth, pageHeight, mode, translations, images } = options;
  ...
  placeholderText.setAttrs({
    ...
    fill: CONTENT_PLACEHOLDER_TEXT_COLOR,
