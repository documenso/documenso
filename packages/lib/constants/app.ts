...
export const NEXT_PRIVATE_SIGNING_HTTP_URL = () => env('NEXT_PRIVATE_SIGNING_HTTP_URL');

export const NEXT_PRIVATE_SIGNING_HTTP_AUTH_HEADER = () =>
  env('NEXT_PRIVATE_SIGNING_HTTP_AUTH_HEADER') ?? 'Authorization';

export const NEXT_PRIVATE_SIGNING_HTTP_AUTH_TOKEN = () =>
  env('NEXT_PRIVATE_SIGNING_HTTP_AUTH_TOKEN');

export const NEXT_PRIVATE_SIGNING_HTTP_FORM_FIELD_NAME = () =>
  env('NEXT_PRIVATE_SIGNING_HTTP_FORM_FIELD_NAME') ?? 'file';

export const NEXT_PRIVATE_SIGNING_HTTP_TIMEOUT_MS = () =>
  Number(env('NEXT_PRIVATE_SIGNING_HTTP_TIMEOUT_MS')) || 90_000;
