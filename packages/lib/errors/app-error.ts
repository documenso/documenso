...
export enum AppErrorCode {
  ...
  SIGNUP_INVITE_INVALID = 'SIGNUP_INVITE_INVALID',
  SIGNUP_INVITE_EXPIRED = 'SIGNUP_INVITE_EXPIRED',
...
export const genericErrorCodeToTrpcErrorCodeMap: Record<string, { code: string; status: number }> = {
  ...
  [AppErrorCode.SIGNUP_INVITE_INVALID]: { code: 'BAD_REQUEST', status: 400 },
  [AppErrorCode.SIGNUP_INVITE_EXPIRED]: { code: 'BAD_REQUEST', status: 400 },
