...
export const generateSampleWebhookPayload = (
  ...
  switch (event) {
    case WebhookTriggerEvents.DOCUMENT_CREATED:
      return {
        event,
        payload: {
          ...basePayload,
    ...
    case WebhookTriggerEvents.DOCUMENT_SENT:
      return {
        event,
        payload: {
          ...basePayload,
    ...
    case WebhookTriggerEvents.DOCUMENT_OPENED:
      return {
        event,
        payload: {
          ...basePayload,
    ...
    case WebhookTriggerEvents.DOCUMENT_SIGNED:
      return {
        event,
        payload: {
          ...basePayload,
    ...
    case WebhookTriggerEvents.DOCUMENT_COMPLETED:
      return {
        event,
        payload: {
          ...basePayload,
    ...
    case WebhookTriggerEvents.DOCUMENT_REJECTED:
      return {
        event,
        payload: {
          ...basePayload,
    ...
    case WebhookTriggerEvents.DOCUMENT_CANCELLED:
      return {
        event,
        payload: {
          ...basePayload,
