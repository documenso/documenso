...
export const sendOrganisationDeleteEmail = async ({
  ...
  // This is sent through the global KeepContracts mailer (the org's transport is
  // intentionally not used during deletion), so use the KeepContracts sender to keep
