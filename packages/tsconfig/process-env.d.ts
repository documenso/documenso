declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    NEXT_PRIVATE_JOBS_SIGNING_REMINDERS_SWEEP_CRON?: string;
    NEXT_PRIVATE_JOBS_SEAL_DOCUMENT_SWEEP_CRON?: string;
    NEXT_PRIVATE_JOBS_EXPIRE_RECIPIENTS_SWEEP_CRON?: string;
    NEXT_PRIVATE_JOBS_CLEANUP_RATE_LIMITS_CRON?: string;
    NEXT_PRIVATE_JOBS_SYNC_EMAIL_DOMAINS_CRON?: string;
