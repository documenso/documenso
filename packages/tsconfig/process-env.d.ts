declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    NEXT_PRIVATE_SIGNING_TRANSPORT?: 'local' | 'http' | 'gcloud-hsm' | 'aws-kms' | 'azure-kv';
    ...
    NEXT_PRIVATE_SIGNING_AWS_KMS_KEY_ID?: string;
    NEXT_PRIVATE_SIGNING_AWS_KMS_REGION?: string;
    NEXT_PRIVATE_SIGNING_AWS_KMS_PUBLIC_CRT_FILE_PATH?: string;
    NEXT_PRIVATE_SIGNING_AWS_KMS_PUBLIC_CRT_FILE_CONTENTS?: string;
    NEXT_PRIVATE_SIGNING_AWS_KMS_CERT_CHAIN_FILE_PATH?: string;
    NEXT_PRIVATE_SIGNING_AWS_KMS_CERT_CHAIN_CONTENTS?: string;
    NEXT_PRIVATE_SIGNING_AWS_KMS_SECRETS_MANAGER_CERT_ARN?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_URL?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_KEY_NAME?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_KEY_VERSION?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_ALGORITHM?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_TENANT_ID?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_CLIENT_ID?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_CLIENT_SECRET?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_PUBLIC_CRT_FILE_PATH?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_PUBLIC_CRT_FILE_CONTENTS?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_CERT_CHAIN_FILE_PATH?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_CERT_CHAIN_CONTENTS?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KV_CERT_NAME?: string;
