declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    NEXT_PRIVATE_SIGNING_HTTP_URL?: string;
    NEXT_PRIVATE_SIGNING_HTTP_AUTH_HEADER?: string;
    NEXT_PRIVATE_SIGNING_HTTP_AUTH_TOKEN?: string;
    NEXT_PRIVATE_SIGNING_HTTP_FORM_FIELD_NAME?: string;
    NEXT_PRIVATE_SIGNING_HTTP_TIMEOUT_MS?: string;
