...
var _abstract_reference = _interopRequireDefault(
  require("./abstract_reference")
);
...
class PDFObject {
  static convert(object, encryptFn = null) {
    ...
    if (object instanceof Date) {
      let string = `D:${pad(object.getUTCFullYear(), 4)}${pad(
        object.getUTCMonth() + 1,
        2
      )}${pad(object.getUTCDate(), 2)}${pad(object.getUTCHours(), 2)}${pad(
        object.getUTCMinutes(),
        2
      )}${pad(object.getUTCSeconds(), 2)}Z`; // Encrypt the string when necessary
