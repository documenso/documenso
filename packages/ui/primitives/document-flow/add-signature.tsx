            ...
            <div className="space-y-4">
              ...
              {requireName && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required={requireName}>სახელი</FormLabel>
                      <FormControl>
                        <Input
                          className="bg-background"
                          {...field}
              ...
              {requireSignature && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required={requireSignature}>ხელმოწერა</FormLabel>
                      <FormControl>
                        <Card
                          className={cn('mt-2', {
              ...
              {requireCustomText && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required={requireCustomText}>ტექსტი</FormLabel>
                      <FormControl>
                        <Input
                          className="bg-background"
                          {...field}
