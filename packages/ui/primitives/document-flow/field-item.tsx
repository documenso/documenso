...
export const combinedStyles = {
  'orange-500': {
    ...
    border: 'border-orange-500 ring-orange-500/10 ring-offset-orange-500/10 ring-2 ring-offset-2',
    borderActive:
      'border-orange-500 bg-orange-500/20 ring-1 ring-offset-1 ring-background ring-offset-background shadow-none',
  ...
  'green-500': {
    ...
    border: 'border-green-500 ring-green-500/10 ring-offset-green-500/10 ring-2 ring-offset-2',
    borderActive:
      'border-green-500 bg-green-500/20 ring-1 ring-offset-1 ring-background ring-offset-background shadow-none',
  ...
  'cyan-500': {
    ...
    border: 'border-cyan-500 ring-cyan-500/10 ring-offset-cyan-500/10 ring-2 ring-offset-2',
    borderActive:
      'border-cyan-500 bg-cyan-500/20 ring-1 ring-offset-1 ring-background ring-offset-background shadow-none',
  ...
  'blue-500': {
    ...
    border: 'border-blue-500 ring-blue-500/10 ring-offset-blue-500/10 ring-2 ring-offset-2',
    borderActive:
      'border-blue-500 bg-blue-500/20 ring-1 ring-offset-1 ring-background ring-offset-background shadow-none',
  ...
  'indigo-500': {
    ...
    border: 'border-indigo-500 ring-indigo-500/10 ring-offset-indigo-500/10 ring-2 ring-offset-2',
    borderActive:
      'border-indigo-500 bg-indigo-500/20 ring-1 ring-offset-1 ring-background ring-offset-background shadow-none',
  ...
  'purple-500': {
    ...
    border: 'border-purple-500 ring-purple-500/10 ring-offset-purple-500/10 ring-2 ring-offset-2',
    borderActive:
      'border-purple-500 bg-purple-500/20 ring-1 ring-offset-1 ring-background ring-offset-background shadow-none',
  ...
  'pink-500': {
    ...
    border: 'border-pink-500 ring-pink-500/10 ring-offset-pink-500/10 ring-2 ring-offset-2',
    borderActive:
      'border-pink-500 bg-pink-500/20 ring-1 ring-offset-1 ring-background ring-offset-background shadow-none',
  ...
  'gray-500': {
    ...
    border: 'border-gray-500 ring-gray-500/10 ring-offset-gray-500/10 ring-2 ring-offset-2',
    borderActive:
      'border-gray-500 bg-gray-500/20 ring-1 ring-offset-1 ring-background ring-offset-background shadow-none',
