...
>(({ className, children, overlayClassName, position = 'start', hideClose = false, ...props }, ref) => (
  <DialogPortal position={position}>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-10 sm:zoom-in-90 data-[state=open]:sm:slide-in-from-bottom-0 fixed z-50 grid w-full animate-in gap-4 border bg-background p-5 shadow-lg sm:max-w-lg sm:rounded-lg',
        {
