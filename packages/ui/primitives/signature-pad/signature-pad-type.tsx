  ...
  return (
    <div className={cn('flex h-full w-full items-center justify-center', className)}>
      <input
        ...
        className="w-full bg-transparent px-4 text-center font-signature text-7xl text-foreground placeholder:text-3xl focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0"
