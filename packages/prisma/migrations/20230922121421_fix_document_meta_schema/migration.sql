...
DROP CONSTRAINT "Document_documentMetaId_fkey";
...
SET
  "documentId" = (
    ...
    FROM
      "Document"
    WHERE
      "Document"."documentMetaId" = "DocumentMeta"."id"
  );
...
-- Prune data
DELETE FROM "DocumentMeta"
WHERE
  "documentId" IS NULL;

-- AlterTable
ALTER TABLE "Document"
DROP COLUMN "documentMetaId";
...
-- AddForeignKey
ALTER TABLE "DocumentMeta"
ADD CONSTRAINT "DocumentMeta_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
