...
-- DropForeignKey
ALTER TABLE "Share"
DROP CONSTRAINT "Share_documentId_fkey";

-- DropForeignKey
ALTER TABLE "Share"
DROP CONSTRAINT "Share_recipientId_fkey";
...
ADD CONSTRAINT "DocumentShareLink_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
