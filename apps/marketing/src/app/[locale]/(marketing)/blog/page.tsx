...
export default async function BlogPage({ params: { locale } }: PageParams) {
  ...
  return (
    <div className="mt-6 sm:mt-12">
      <div className="text-center">
        <h1 className="text-3xl font-bold lg:text-5xl">{t('from_the_blog')}</h1>

        <p className="text-muted-foreground mx-auto mt-4 max-w-xl text-center text-lg leading-normal">
          {t('get_the_latest_from-_documenso')}
        </p>
      </div>
