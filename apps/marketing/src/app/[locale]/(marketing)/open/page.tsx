...
export default async function OpenPage({ params: { locale } }: PageParams) {
  ...
  return (
    <div className="mx-auto mt-6 max-w-screen-lg sm:mt-12">
      ...
      <div className="mt-12 grid grid-cols-12 gap-8">
        ...
        <TeamMembers locale={locale} className="col-span-12" />

        <SalaryBands locale={locale} className="col-span-12" />
        ...
        <BarMetric<EarlyAdoptersType>
          ...
          extraInfo={<OpenPageTooltip locale={locale} />}
        />
        ...
        <div className="col-span-12 mt-12 flex flex-col items-center justify-center">
          <h2 className="text-2xl font-bold">{t('where_is_the_rest')}</h2>

          <p className="text-muted-foreground mt-4 max-w-[55ch] text-center text-lg leading-normal">
            {t('we_are_still_working_on_getting_all_our_metrics_together')}
          </p>
        </div>
      </div>
    </div>
