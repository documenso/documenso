...
export const SinglePlayerClient = () => {
  ...
  const documentFlow: Record<SinglePlayerModeStep, DocumentFlowStep> = {
    fields: {
      ...
      description: `${t('uploaded_document_and_add_fileds')}`,
      stepIndex: 1,
    ...
    sign: {
      title: `${t('sign')}`,
      description: `${t('enter_your_details')}`,
      stepIndex: 2,
  ...
  return (
    <div className="mt-6 sm:mt-12">
      <div className="text-center">
        <h1 className="text-3xl font-bold lg:text-5xl">{t('single_player_mode')}</h1>
