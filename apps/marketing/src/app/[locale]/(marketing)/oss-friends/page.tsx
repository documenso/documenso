...
export default async function OSSFriendsPage({ params: { locale } }: PageParams) {
    ...
    <div className="relative mt-12">
      <div className="text-center">
        <h1 className="text-3xl font-bold lg:text-5xl">
          {t('our')}
          <span title="Open Source Software">OSS</span> {t('friends')}
        </h1>

        <p className="text-foreground mx-auto mt-4 max-w-[55ch] text-lg leading-normal">
          {t('we_love_open_source_and_so_should_you')}
        </p>
      </div>
