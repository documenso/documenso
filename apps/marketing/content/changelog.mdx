...
We're excited to announce the release of Documenso v1.6.0! The new release is packed with new features and improvements to streamline your document signing process. Here are the highlights:
...
- Force Signature Fields: Document creators can now ensure that all required signature fields are completed by signers.
...
- Anonymous SMTP Authentication: For those who need it, we now support anonymous SMTP authentication.
