...
At Notario, we aim to be a design-driven company.
...
To achieve this, we've created Notario's design system containing tokens, primitives, and components, screens, and brand assets.
