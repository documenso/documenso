...
You can now create teams, next to your personal account, invite your colleagues, and do everything else you want to include in working with your documents. Teams can:
...
- Define a dedicated team email, to receive signing requests into a team inbox
