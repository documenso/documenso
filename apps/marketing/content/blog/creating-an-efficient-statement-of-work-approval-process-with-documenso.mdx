...
<figure>
  <MdxNextImage
    ...
    width="1400"
    height="884"
    alt="Documenso Roles UI"
  />

  <figcaption className="text-center">Let's take a look at what it would look like with Documenso.</figcaption>
</figure>
