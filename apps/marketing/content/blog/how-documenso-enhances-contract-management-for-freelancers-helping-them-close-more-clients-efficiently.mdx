...
Once you have your contract ready you can upload it and add recipients as well as signature fields. To add a more personal touch, consider adding a personal message to the signature request. 
...
<figure>
  ...
  <figcaption className="text-center">
    Copy recipient links, to manually send them for a personal touch.
  </figcaption>
</figure>
...
<figure>
  ...
  <figcaption className="text-center">
      Trigger any kind of notifcation with Zapier.
  </figcaption>
</figure>
