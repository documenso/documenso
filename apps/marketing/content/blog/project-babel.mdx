...
<figure>
  ...
  <figcaption className="text-center">Lorem Ipsum Sit Dolor Babel.</figcaption>
</figure>
...
At Documenso, we believe that open source is more than just a software philosophy—it’s a way to build solutions that are open to all, technically and economically. Now, we’re proud to take that mission further with Project Babel, a community-driven initiative designed to bring worldwide language support to the Documenso platform. This project aims to enable Documenso to offer more languages than any other e-signature tool by harnessing the power of the open source community.
