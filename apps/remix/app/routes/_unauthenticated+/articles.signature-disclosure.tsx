  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using PSD Document Signing to perform your electronic document signing.
            The purpose of this disclosure is to inform you about the process, legality, and your
            rights regarding the use of electronic signatures on our platform. By opting to use an
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by PSD Document Signing,
            you affirm that you have read and understood this disclosure. You agree to all terms and
