...
import { ZUpdateOrganisationSettingsRequestSchema } from '@documenso/trpc/server/organisation-router/update-organisation-settings.types';
...
const ZEmailPreferencesFormSchema = ZUpdateOrganisationSettingsRequestSchema.shape.data.pick({
  emailId: true,
  emailReplyTo: true,
  emailReplyToName: true,
  emailDocumentSettings: true,
});
...
type SettingsSubset = Pick<
  TeamGlobalSettings,
  'emailId' | 'emailReplyTo' | 'emailReplyToName' | 'emailDocumentSettings'
>;
...
export const EmailPreferencesForm = ({
  ...
  const { data: emailData, isLoading: isLoadingEmails } = trpc.organisation.email.find.useQuery({
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormMessage />
                <FormDescription>
                  <Trans>The email address to use when replying to emails sent by Documenso</Trans>
                </FormDescription>
              </FormItem>
            )}
          />
