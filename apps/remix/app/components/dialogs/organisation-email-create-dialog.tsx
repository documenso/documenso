...
import { ZCreateOrganisationEmailRequestSchema } from '@documenso/trpc/server/organisation-router/create-organisation-email.types';
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            <Trans>
              ...
              <span className="font-mono">{emailDomain.domain}</span>.
            </Trans>
          </DialogDescription>
        </DialogHeader>
