...
import { ZUpdateOrganisationEmailRequestSchema } from '@documenso/trpc/server/organisation-router/update-organisation-email.types';
...
export const OrganisationEmailUpdateDialog = ({
  ...
  const onFormSubmit = async ({ emailName, replyTo }: ZUpdateOrganisationEmailSchema) => {
    try {
