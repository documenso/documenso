...
import type { TNumberFieldMeta } from '@doku-seal/lib/types/field-meta';
...
import { numberFormatValues } from '@doku-seal/ui/primitives/document-flow/field-items-advanced-settings/constants';
import {
  Form,
  FormControl,
  FormField,
