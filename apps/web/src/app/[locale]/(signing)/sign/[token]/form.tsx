      ...
      >
        <div className={cn('flex flex-1 flex-col')}>
          <h3 className="text-foreground text-2xl font-semibold">
            {recipient.role === RecipientRole.VIEWER && `${t('view_document')}`}
            {recipient.role === RecipientRole.SIGNER && `${t('sign_document')}`}
            {recipient.role === RecipientRole.APPROVER && `${t('approve_document')}`}
          </h3>

          {recipient.role === RecipientRole.VIEWER ? (
            <>
              <p className="text-muted-foreground mt-2 text-sm">{t('mark_as_viewed')}</p>
            ...
            <>
              <p className="text-muted-foreground mt-2 text-sm">
                {t('review_the_document_before_signing')}
              </p>
