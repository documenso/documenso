...
export const ResendDocumentActionItem = ({
  ...
  const onFormSubmit = async ({ recipients }: TResendDocumentFormSchema) => {
    try {
      ...
      toast({
        title: `${t('document_re_sent')}`,
        description: `${t('document_re_sent_successfully')}`,
        duration: 5000,
      });
      ...
      toast({
        ...
        description: `${t('document_could_not_be_re_sent_this_time')}`,
        variant: 'destructive',
        duration: 7500,
      });
    }
    ...
    <>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="sm:max-w-sm" hideClose>
          <DialogHeader>
            <DialogTitle>
              <h1 className="text-center text-xl">{t('who_do_you_want_to_remind')}</h1>
            </DialogTitle>
          </DialogHeader>
