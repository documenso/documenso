...
export const DocumentsDataTable = ({ locale = 'en', results }: DocumentsDataTableProps) => {
  ...
  return (
    <div className="relative">
      <DataTable
        columns={[
          ...
          },
          {
            header: `${t('status')}`,
            accessorKey: 'status',
            cell: ({ row }) => <DocumentStatus locale={locale} status={row.original.status} />,
          },
        ]}
        data={results.data}
      ...
      >
        {(table) => (
          <DataTablePagination locale={locale} additionalInformation="VisibleCount" table={table} />
        )}
      </DataTable>
