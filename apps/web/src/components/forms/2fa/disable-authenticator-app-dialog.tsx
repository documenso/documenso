  ...
  const onDisable2FAFormSubmit = async ({ token }: TDisable2FAForm) => {
    try {
      ...
      toast({
        ...
        description:
          'სისტემაში შესვლისას აღარ მოგიწევთ კოდის შეყვანა თქვენი ავთენტიფიკატორის აპლიკაციიდან.',
      });
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent position="center">
        <DialogHeader>
          ...
          <DialogDescription>
            გთხოვთ მოგვაწოდოთ სარეზერვო კოდი ან ტოკენი ავთენტიფიკატორი აპლიკაციიდან.
            {/* თუ არ გაქვთ სარეზერვოკოდი, გთხოვთ დაგვიკავშირდეთ. */}
          </DialogDescription>
        </DialogHeader>
