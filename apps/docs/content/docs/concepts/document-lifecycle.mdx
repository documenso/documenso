...
description: Understanding document states from draft to completion
---

# Document Lifecycle

Every document in Documenso moves through a series of states from creation to completion. Understanding these states helps you track document progress and know what actions are available at each stage.
