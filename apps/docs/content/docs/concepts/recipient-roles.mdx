...
When you add recipients to a document, you assign each one a role that determines what actions they can take. Documenso supports five recipient roles, each with different permissions and requirements.
