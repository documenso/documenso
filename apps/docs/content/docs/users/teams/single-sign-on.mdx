...
description: Configure SSO for your team with OIDC providers
---

import { Callout } from 'fumadocs-ui/components/callout';
import { Step, Steps } from 'fumadocs-ui/components/steps';

Single Sign-On (SSO) allows your team members to authenticate using your organization's identity provider instead of managing separate Documenso credentials.
...
<Callout type="info">You must be a team owner, admin, or manager to configure SSO.</Callout>
...
- **Manager**: Can manage documents and team settings
- **Admin**: Full access to team configuration
...
3. The user is added to your team with the default role
4. They can immediately access team documents
...
Once SSO is enabled, you can share your team's SSO portal URL with members. The portal URL is displayed at the top of the SSO settings page.

To enforce SSO-only authentication:

1. Share only the SSO portal URL with team members
2. Restrict allowed email domains to your organization
3. Remove any team members who signed up with passwords
...
- [Manage Members](/docs/users/teams/manage-members) - Configure team member roles and permissions
