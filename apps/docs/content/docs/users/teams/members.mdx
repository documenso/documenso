...
<Steps>
  ...
  <Step>
    Select organization members from the list and click **Next**.
  </Step>
  <Step>
...
<Steps>
  <Step>
    In the **Add members** dialog, click **Invite them to the organization first**.
  </Step>
  <Step>
    Enter their email address and organization role, then click **Send invite**.
  </Step>
  <Step>
