...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@documensomail.com` (free plan) or `noreply@documenso.com` (paid plans).
