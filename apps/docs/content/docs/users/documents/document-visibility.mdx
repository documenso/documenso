...
The default document visibility is set to "_EVERYONE_" by default. You can change this setting by going to the [document preferences page](/docs/users/documents/document-preferences) and selecting a different visibility option.
