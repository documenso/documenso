...
>
  <Tab value="Two-party agreement">Add yourself and the other party as signers.</Tab>
  <Tab value="Contract with witness">Add the main signer plus a viewer as witness.</Tab>
  <Tab value="Approval workflow">Add an approver first, then signers.</Tab>
  <Tab value="Keep stakeholders informed">Add CC recipients who receive the final document.</Tab>
</Tabs>
