...
description: Add signers, approvers, viewers, and CC recipients to your document.
---

import { Callout } from 'fumadocs-ui/components/callout';
import { Step, Steps } from 'fumadocs-ui/components/steps';

Recipients are the people who interact with your document. This includes signers who need to sign, approvers who review and approve, viewers who acknowledge receipt, and CC recipients who receive a copy of the completed document.
...
After adding recipients, you need to place fields on the document for them to complete:
