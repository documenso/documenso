...
<Steps>
  <Step>Click **Send Document** in the document editor.</Step>
  <Step>
    Choose the distribution method: **Email** (recipients get signing links by email) or **None**
    (you get links to share manually).
  </Step>
  <Step>If using email, configure subject, message, and reply-to as needed.</Step>
  <Step>Click **Send** or **Generate Links**.</Step>
</Steps>
...
<Steps>
  <Step>Open the document from your Documents page.</Step>
  <Step>Click the actions menu (three dots) and select **Resend**.</Step>
  <Step>Check the recipients you want to remind, then click **Send reminder**.</Step>
</Steps>
...
<Steps>
  <Step>Open the document from your Documents page.</Step>
  <Step>Click the actions menu (three dots) and select **Delete**.</Step>
  <Step>Type "delete" to confirm, then click **Delete**.</Step>
</Steps>
...
<Steps>
  <Step>The document is sent without notifying recipients.</Step>
  <Step>You're redirected to the document page where signing links are displayed.</Step>
  <Step>
