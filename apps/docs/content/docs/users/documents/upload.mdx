...
description: Supported formats and upload methods
---

import { Callout } from 'fumadocs-ui/components/callout';

Upload documents to Documenso to prepare them for signing. This page covers supported formats, file size limits, and upload methods.

## Limitations

Before uploading, be aware of these constraints:
...
2. Drag a PDF file from your computer and drop it anywhere on the page
...
1. Select multiple PDF files when using the file picker, or
2. Drag and drop multiple PDF files at once
...
Convert your document to PDF before uploading. Most applications (Word, Google Docs, etc.) can export to PDF format.

### "You cannot upload encrypted PDFs"

The PDF is password-protected or encrypted. Open it in a PDF reader, remove the security settings, and save a new copy.
...
After uploading, you're ready to prepare your document for signing:
...
- [Send and track](/docs/users/documents/send-and-track) - Send the document and monitor progress
