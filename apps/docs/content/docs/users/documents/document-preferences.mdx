...
- **Document Visibility** - Set the default visibility of the documents created by team members. Learn more about [document visibility](/docs/users/documents/document-visibility).
...
- **Sender Details** - Set whether the sender's name should be included in the emails sent by the team. See more below [sender details](/docs/users/documents/document-preferences#sender-details).
