---
title: Direct Links
description: Share signing links without knowing recipient emails upfront.
---
...
Direct links let you share a signing URL without knowing the recipient's email address in advance. Recipients can open the link, enter their information, and sign the document.
...
- [Create a Template](/docs/users/templates/create-template) - Set up a template to use with direct links
- [API: Create from Template](/docs/developers/api/templates) - Generate documents from templates programmatically
