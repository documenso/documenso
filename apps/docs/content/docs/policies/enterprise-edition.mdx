...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organizations to integrate Documenso into proprietary products.
---
...
Yes. Your existing deployment can transition to the Enterprise license. Contact [sales](https://documen.so/enterprise) to discuss migration.
...
Contact [sales](https://documen.so/enterprise) to discuss evaluation options for your organization.
