---
title: Direct Link Embedding
description: Embed document signing using direct links
---

import { Callout } from 'fumadocs-ui/components/callout';
import { Tab, Tabs } from 'fumadocs-ui/components/tabs';

Direct links provide a simple way to embed document signing into your application without building complex integrations. Share a URL or embed it in an iframe, and users can sign documents directly.

## What Are Direct Links?

Direct links are unique URLs tied to a template that allow anyone to:

1. View and sign a document without receiving an email invitation
2. Enter their own name and email address
3. Complete signature fields and submit the document
...
1. Go to **Templates** and create or select a template

![Team templates](/embedding/team-templates.png)

2. Click the three-dot menu and select **Direct link**
3. Click **Enable direct link signing**
4. Choose which recipient in your template will use the direct link
...
<Callout type="info">
  ...
  for iframe embedding with reduced navigation chrome.
</Callout>
...
3. Set **Redirect URL** to your desired return URL (e.g., `https://yourapp.com/signed`)
...
The signing experience uses your organization's branding settings:
...
```typescript
// Webhook payload for DOCUMENT_SIGNED event
{
...
- [React Components](/docs/developers/embedding/react) - For deeper React integration
