...
Documenso provides official embedding SDKs for all popular JavaScript frameworks. Install the package for your framework and embed document signing with a few lines of code.
...
1. Navigate to your team's templates in Documenso

![Team Templates](/embedding/team-templates.png)

2. Click on a direct link template to copy its URL. The token is the last segment of the URL.
