...
2. **Test dark mode** - If dark mode is not disabled, verify your variables work in both modes.
3. **Match your brand** - Align `primary` and `accent` colors with your brand for a cohesive look.
4. **Consistent radius** - Use a border radius that matches your application's design system.
