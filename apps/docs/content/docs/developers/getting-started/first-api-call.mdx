...
description: Create and send a document programmatically.
---
...
This guide walks you through creating and sending a document for signing using the Documenso API. By the end, you'll have a working script that uploads a PDF, adds a recipient with a signature field, and sends it for signing.
