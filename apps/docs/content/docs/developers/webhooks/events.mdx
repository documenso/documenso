...
Triggered when a recipient views the document. Unlike `document.opened`, this event fires every time the document is viewed, not just the first time.

**Event name:** `DOCUMENT_VIEWED`
...
```json
{
  ...
  "createdAt": "2024-04-22T11:50:30.000Z",
  "webhookEndpoint": "https://your-endpoint.com/webhook"
}
```
...
| `DOCUMENT_VIEWED`            | Recipient views the document                 | Recipient `readStatus: "OPENED"`                             |
