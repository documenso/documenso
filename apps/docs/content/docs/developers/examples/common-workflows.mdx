...
3. Enter your webhook URL (e.g., `https://your-app.com/webhooks/documenso`)
4. Select which events to subscribe to: `DOCUMENT_SENT`, `DOCUMENT_OPENED`, `DOCUMENT_SIGNED`, `DOCUMENT_COMPLETED`, `DOCUMENT_REJECTED`
5. Enter your webhook secret (the same value stored in `DOCUMENSO_WEBHOOK_SECRET`)
