...
See the [PDF Placeholders](/docs/users/documents/pdf-placeholders) guide for the full placeholder format reference, including supported field types, recipient identifiers, and field options.
