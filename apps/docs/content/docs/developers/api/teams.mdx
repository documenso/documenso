---
title: Teams API
description: Access team resources via API
---

import { Callout } from 'fumadocs-ui/components/callout';
import { Tab, Tabs } from 'fumadocs-ui/components/tabs';

Teams allow you to organize documents, templates, and members within your organization. API tokens are scoped to a specific team, so all operations performed with that token automatically access team resources.
