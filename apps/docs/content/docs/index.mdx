...
<div className="not-prose max-w-4xl mx-auto px-4">
  <div className="mb-12 text-center pt-6">
    <h1 className="text-4xl font-bold tracking-tight mb-4">Documenso Documentation</h1>
  ...
  <div className="rounded-xl border bg-gradient-to-r from-fd-primary/5 to-fd-primary/10 p-6 text-center">
    ...
    <div className="flex flex-wrap justify-center gap-3">
      ...
      <a href="https://documenso.com/discord" className="inline-flex items-center gap-2 rounded-lg bg-fd-background border px-4 py-2 text-sm font-medium hover:bg-fd-accent transition-colors">
