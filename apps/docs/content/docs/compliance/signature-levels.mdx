...
description: Understanding SES, AES, and QES signature types
---

# Signature Levels

Electronic signature regulations, particularly the EU's eIDAS framework, define three levels of electronic signatures. Each level has different technical requirements, legal implications, and use cases. Understanding these levels helps you choose the appropriate signature type for your documents.
