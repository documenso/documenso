...
| `DISABLE_SIGNUP`                      | Master switch — disable all signup methods             | `false` |
| `NEXT_PUBLIC_DISABLE_SIGNUP`          | Legacy alias for `DISABLE_SIGNUP`                      | `false` |
| `DISABLE_EMAIL_PASSWORD_SIGNUP`       | Disable email/password signup only                     | `false` |
| `DISABLE_GOOGLE_SIGNUP`               | Block new accounts via Google OAuth                    | `false` |
| `DISABLE_MICROSOFT_SIGNUP`            | Block new accounts via Microsoft OAuth                 | `false` |
| `DISABLE_OIDC_SIGNUP`                 | Block new accounts via OIDC (incl. organisation portal)| `false` |
