...
If your Microsoft tenant does not emit an `email_verified` claim and you trust
tenant-managed email identities, you can bypass that claim check:

```
NEXT_PRIVATE_MICROSOFT_SKIP_VERIFY=true
```
