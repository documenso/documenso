...
| Variable                         | Description                                         | Default |
| -------------------------------- | --------------------------------------------------- | ------- |
| `NEXT_PRIVATE_SIGNING_TRANSPORT` | Signing backend: `local`, `gcloud-hsm`, or `aws-kms` | `local` |
...
| Variable                                                | Description                                                         |
| ------------------------------------------------------- | ------------------------------------------------------------------- |
| `NEXT_PRIVATE_SIGNING_AWS_KMS_KEY_ID`                   | AWS KMS key ID or full ARN                                          |
| `NEXT_PRIVATE_SIGNING_AWS_KMS_REGION`                   | AWS region of the KMS key                                           |
...
AWS credentials are resolved by the AWS SDK's default credential chain (env vars, IAM task role, EC2/Lambda instance profile, shared credentials file).
