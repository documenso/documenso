...
For a complete list of available CSS variables and their usage, see our [CSS Variables](/docs/developers/embedding/css-variables) documentation.
...
- [React](/docs/developers/embedding/react)
- [Preact](/docs/developers/embedding/preact)
- [Vue](/docs/developers/embedding/vue)
- [Svelte](/docs/developers/embedding/svelte)
- [Solid](/docs/developers/embedding/solid)
- [Angular](/docs/developers/embedding/angular)
...
For detailed implementation instructions and code examples, see our [Embedded Authoring](/docs/developers/embedding/authoring) guide.

## Related

- [React Integration](/docs/developers/embedding/react)
- [Vue Integration](/docs/developers/embedding/vue)
- [Svelte Integration](/docs/developers/embedding/svelte)
- [Solid Integration](/docs/developers/embedding/solid)
- [Preact Integration](/docs/developers/embedding/preact)
- [Angular Integration](/docs/developers/embedding/angular)
- [CSS Variables](/docs/developers/embedding/css-variables)
- [Embedded Authoring](/docs/developers/embedding/authoring)
