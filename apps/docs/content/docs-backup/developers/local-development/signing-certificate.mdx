...
Details about environment variables associated with certificates can be found [here](/docs/developers/self-hosting/signing-certificate#configure-documenso-to-use-the-certificate).
