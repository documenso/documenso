...
See the [Microsoft Entra ID](/docs/users/organisations/sso/microsoft-entra-id) guide to find the values for the following fields.
...
- [Microsoft Entra ID](/docs/users/organisations/sso/microsoft-entra-id) - Complete guide for Azure AD configuration
