...
For full AI setup details (including model availability notes), see the [AI Recipient & Field Detection (Self-hosting)](/docs/self-hosting/configuration/ai-features) page.
...
For AI setup specifics, see the [AI Recipient & Field Detection (Self-hosting)](/docs/self-hosting/configuration/ai-features) page.
...
| `DOCUMENSO_DISABLE_TELEMETRY`                | Set to `true` to disable anonymous telemetry (see [Telemetry](/docs/self-hosting/configuration/telemetry) section below).                                                           |
| `GOOGLE_VERTEX_PROJECT_ID`                   | Google Cloud project ID used for Vertex AI (required for AI detection).                                                                                                             |
| `GOOGLE_VERTEX_API_KEY`                      | Vertex AI Express API key with access to Gemini models (required for AI detection). See [AI Recipient & Field Detection](/docs/self-hosting/configuration/ai-features) for details. |
