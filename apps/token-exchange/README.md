...
**Token Exchange:** Deploy as a separate Render service (e.g. `token-exchange-xxx.onrender.com` or custom domain `token-exchange.pinogy.com`).
...
const tokenExchangeUrl = 'https://token-exchange.pinogy.com';  // or your Render URL
