...
If you add placeholders to the template, you must replace them with actual recipients when creating a document from the template. See the modal from ["Use a Template"](#use-a-template) section.
