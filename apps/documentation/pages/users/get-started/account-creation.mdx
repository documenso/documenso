...
Explore each plan's features and choose the one that best suits your needs. The [pricing page](https://document.so/pricing) has more information about the plans.
...
To create a free account, navigate to the [registration page](https://document.so/free) and fill in the required information.
