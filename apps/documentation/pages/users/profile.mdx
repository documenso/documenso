...
You can choose to make your profile public or private. If you make it private, only you can access it. If you make it public, anyone with the link can access it.
...
Linking templates to your profile is optional, but it is what makes your profile helpful. Linking templates allow people to sign documents directly from your profile. As a result, we recommend linking at least one template you want to share with others.

Learn more about [templates](/users/templates).

### Publish your Profile

After you have configured your profile, click the "Update" button at the bottom of the page to publish it. Once you have published your profile, you can share the link with others if you made it public.
