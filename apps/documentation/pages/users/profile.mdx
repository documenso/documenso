...
description: Learn how to set up your public profile on Doku-Seal.
---
...
Doku-Seal allows you to create a public profile to share your templates for anyone to sign. This is useful for distributing and collecting signatures for commonly used documents, making it more efficient for both the document creator and the signers.

<Callout type="info">A free Doku-Seal account gives you 5 free signatures per month.</Callout>
...
![The profile settings page](/public-profile/doku-seal-public-profile-settings.webp)
...
```bash
https://app.doku-seal.com/p/<username>
```
...
![An example of a enabling a public profile on Doku-Seal](/public-profile/doku-seal-enable-public-profile-settings.webp)
...
![An example of a public profile on Doku-Seal](/direct-links/doku-seal-profile.webp)

The image above shows an example of a public profile on Doku-Seal.
...
<Callout>Tag @doku-seal on X to get a retweet and an endorsement from us.</Callout>
