...
![A screenshot of the document visibility selector from the team's global settings page](/teams/team-global-settings-document-visibility-select.webp)

If you don't set a default visibility option in the [team global settings](/users/teams/global-settings), the visibility of a document is determined by the role of the user who created the document.

<Callout type="warning">
  If the default visibility option is set to "EVERYONE" in the global team settings, the document
  will automatically inherit the visibility of the user who created it.
</Callout>
...
<Callout type="warning">
  Updating the default document visibility in the team's global settings will not affect the
