...
> Read more about 21 CFR Part 11 with Doku-Seal here: https://doku.se/21-CFR-Part-11
...
<Callout type="info" emoji="✅">
  Status: [Compliant](https://doku.se/trust)
</Callout>
...
<Callout type="warning" emoji="⏳">
  Status: [Planned](https://github.com/doku-seal/backlog/issues/26)
</Callout>
...
<Callout type="warning" emoji="⏳">
  Status: [Planned](https://github.com/doku-seal/backlog/issues/25)
</Callout>
