...
description: All Documenso plans are subject to our fair use policy.
---
...
- Experiment with the plans and integrations, testing what you want to build: When in doubt, do it.
...
<Callout type="info">
  What happens if I violate this policy? We will kindly ask you to upgrade to a fitting plan or
  custom pricing.
</Callout>
