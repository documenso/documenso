...
![Doku-Seal dashboard](/document-signing/documenso-documents-dashboard.webp)
...
![The available field types in the Doku-Seal dashboard](/document-signing/documenso-document-fields.webp)
...
![Preview section in the Doku-Seal editor](/document-signing/documenso-editor-preview.webp)

### Email Settings

Before sending the document, you can configure the email settings and customize the subject line, message, and sender name.

![Email settings in the Doku-Seal dashboard](/document-signing/documenso-document-email-settings.webp)
...
![How to copy the signing link for each recipient from the Doku-Seal dashboard](/document-signing/documenso-signing-links.webp)
...
![General Doku-Seal editor settings](/document-signing/documenso-editor-general-settings.webp)
...
![Email Doku-Seal editor settings](/document-signing/documenso-editor-email-settings.webp)
...
![Security Doku-Seal editor settings](/document-signing/documenso-editor-security-settings.webp)
