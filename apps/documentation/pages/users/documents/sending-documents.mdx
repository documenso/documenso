...
The guide assumes you have a Doku-Seal account. If you don't, you can create a free account [here](https://doku.se/free-docs).

### Upload Document

Navigate to the [Doku-Seal dashboard](https://app.doku-seal.com/documents) and click on the "Upload Document" button located at the top right of the page. Select the documents you want to upload and wait for the upload to complete.
...
![Doku-Seal dashboard](/document-signing/doku-seal-documents-dashboard.webp)
...
The Doku-Seal editor allows you to create and configure documents or templates. The editor consists of three sections that guide you through the process of preparing your document.
...
![Editor page in the Doku-Seal dashboard](/document-signing/editor-overview.webp)
...
![Upload and add recipients page in the Doku-Seal editor](/document-signing/editor-upload-recipients.webp)
...
Doku-Seal has 5 roles for recipients with different permissions and actions.
...
Doku-Seal supports 10 different field types that can be added to the document. Each field type collects various information from the recipients when they sign the document.
...
![The available field types in the Doku-Seal dashboard](/document-signing/doku-seal-document-fields.webp)
...
![Preview section in the Doku-Seal editor](/document-signing/doku-seal-editor-preview.webp)

### Email Settings

Before sending the document, you can configure the email settings and customize the subject line, message, and sender name.

![Email settings in the Doku-Seal dashboard](/document-signing/doku-seal-document-email-settings.webp)

If you leave the email subject and message empty, Doku-Seal will use the default email template.
...
![The email sent to the recipients with the signing link](/document-signing/doku-seal-sign-email.webp)
...
![How to copy the signing link for each recipient from the Doku-Seal dashboard](/document-signing/doku-seal-signing-links.webp)

The signing link has the following format:

```bash
https://app.doku-seal.com/sign/12ACP777zxQLO52hjj_vCB
```
...
![General Doku-Seal editor settings](/document-signing/doku-seal-editor-general-settings.webp)
...
![Email Doku-Seal editor settings](/document-signing/doku-seal-editor-email-settings.webp)
...
Doku-Seal enables you to set up access control for your documents. You can require authentication for viewing the document.
...
![Security Doku-Seal editor settings](/document-signing/doku-seal-editor-security-settings.webp)
