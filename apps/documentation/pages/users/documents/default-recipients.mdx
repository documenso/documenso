...
You can add default recipients with the same roles as the recipients you can add to a document:
...
Then scroll down to the "Default Recipients" section and add the recipients you want to be added to every document you send.
...
The recipients have the "CC" role by default, but you can select a different role for each recipient.
