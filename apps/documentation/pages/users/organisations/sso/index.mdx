...
- **Single Sign-On**: Access Doku-Seal using your own authentication system
...
Create a custom subdomain for your organisation's SSO portal. For example, you can create a subdomain like `doku-seal.your-organisation.com` which redirects to the portal link.
...
- Ensure the redirect URI in Doku-Seal matches exactly what's configured in your identity provider
...
2. Check the Doku-Seal logs for detailed error messages
