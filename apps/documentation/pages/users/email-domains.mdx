...
Email Domains allow you to send emails to recipients from your own domain instead of the default Doku-Seal email address.
...
- Access to your Doku-Seal organisation as an admin or manager
...
After adding your domain, Doku-Seal will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the Doku-Seal email domains settings page and click the "Verify" button.
