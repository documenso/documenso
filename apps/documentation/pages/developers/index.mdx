...
description: Learn how to run Doku-Seal locally, use our API, integrate webhooks, contribute to the project, and self-host Doku-Seal.
---
...
<Cards>
  ...
  <Card title="Self-host Doku-Seal" href="/developers/self-hosting" />
</Cards>
