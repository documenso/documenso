...
2. Generate a self-signed certificate inside the container:
...
To avoid file permission issues entirely, you can encode your certificate as base64:
...
echo "NEXT_PRIVATE_SIGNING_PASSPHRASE=your_certificate_password" >> .env
```

This approach eliminates the need for volume mounts and file permission management.
