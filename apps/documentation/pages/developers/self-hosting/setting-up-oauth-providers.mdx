...
description: Learn how to set up OAuth providers for your own instance of Doku-Seal.
---
...
9. Set the authorized javascript origins to `https://<doku-seal-domain>`
10. Set the authorized redirect URIs to `https://<doku-seal-domain>/api/auth/callback/google`
11. In the Doku-Seal environment variables, set the following:
...
5. Enter a name for your application (e.g., "Doku-Seal")
...
7. Under **Redirect URI**, select **Web** and enter: `https://<doku-seal-domain>/api/auth/callback/microsoft`
8. Click **Register**
...
7. In the Doku-Seal environment variables, set the following:
