...
description: Learn how to generate or buy a signing certificate for your Doku-Seal instance.
---
...
Self-hosting your Doku-Seal instance requires your own certificate to sign documents. [This article](https://doku-seal.com/blog/building-doku-seal-pt1) explains why.
...
Receiving your signing certificate is similar to receiving an SSL certificate. Since you need the actual certificate as part of the Doku-Seal config, you must generate a secret private key and a CSR (Certificate Signing Request).
...
### Configure Doku-Seal to use the certificate
