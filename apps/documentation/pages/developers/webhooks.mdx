...
You can create a webhook subscription from the team settings page. Click on your avatar in the top right corner of the dashboard and select "Team settings" from the dropdown menu.
...
You can trigger test webhook events to test the webhook functionality. To trigger a test webhook, navigate to the webhook subscription details page and click the "Test" button.
...
Choose the even you want to test and click "Send." You’ll shortly receive a test payload from Documenso with sample data.
