---
title: Manual Setup
description: Manually set up Doku-Seal on your machine for local development.
---
...
Follow these steps to set up Doku-Seal on your local machine:

<Steps>

### Fork Doku-Seal

Fork the [Doku-Seal repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
```bash
npm run prisma:seed -w @doku-seal/prisma
```
