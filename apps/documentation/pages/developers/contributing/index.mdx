...
description: Learn how to contribute to Doku-Seal and become part of our community.
---
...
This guide will help you get started with contributing to Doku-Seal.
...
Search the existing [issues](https://github.com/doku-seal/doku-seal/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/doku-seal/doku-seal/pulls) to see if someone else is already working on the same thing.
...
<Callout type="info">
  If you need help getting started, [join us on Discord](https://doku.se/discord).
</Callout>
