...
![A screenshot of the Doku-Seal's dashboard that shows the dropdown menu when you click on your user avatar](/public-api-images/documenso-user-dropdown-menu.webp)
...
![A screenshot of the Doku-Seal's user settings page that shows the API Tokens page](/public-api-images/api-tokens-page-documenso.webp)
...
![A screenshot of the newly created API token in the Doku-Seal dashboard](/public-api-images/documenso-api-key-blurred.webp)
