        ...
        <Card className="col-span-2 lg:col-span-1 border border-border">
          <CardContent className="grid grid-cols-1 gap-8 p-6">
            <span className="text-foreground/80 leading-relaxed">
              ...
              Learn how to set up your Documenso account, create and organize your documents, collaborate with team members, and leverage our advanced features.
            </span>
...
<Link href='/local-development'>
        <Card className="col-span-2 lg:col-span-1 border border-border">
          <CardContent className="grid grid-cols-1 gap-8 p-6">
            <span className="text-foreground/80 leading-relaxed">
              <strong className="block">Developers</strong>
              Detailed information on how to set up your local development environment, work with our API, and utilize webhooks for seamless integration.
            </span>
